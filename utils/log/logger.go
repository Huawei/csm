...
var (
	...
	loggingModule = flag.String("logging-module",
		"file",
...
const (
	defaultLogDir   = "/var/log/xuanwu"
	timestampFormat = "2006-01-02 15:04:05.000000"

	xuanWuRequestID      key = "xuanwu.requestid"
	xuanwuChainRequestID     = "xuanwu-chain-requestid"
	requestID                = "requestID"
)
...
func GetXuanWuRequestID() key {
	return xuanWuRequestID
}
...
func (logger *loggerImpl) AddContext(ctx context.Context) Logger {
	if ctx.Value(xuanWuRequestID) == nil {
		return logger
	}
	return logger.AddField(requestID, ctx.Value(xuanWuRequestID))
}
