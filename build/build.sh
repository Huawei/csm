...
cp -rf ../../example ../release

echo "pack manual files"
cp -rf ../../manual ../release
cp -rf ../../helm/huawei-csm/crds ../release/manual/huawei-csm
...
zip -rq -o eSDK_Enterprise_Storage_"${RELEASE_VER}"_CSM_V"${VER}"_"${PLATFORM}"_64.zip *
mkdir ${workdir}/../../output
cp eSDK_Enterprise_Storage_"${RELEASE_VER}"_CSM_V"${VER}"_"${PLATFORM}"_64.zip ${workdir}/../../output
